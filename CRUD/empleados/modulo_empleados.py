...
from estadisticas import cantidad_entidad, porcentaje_empleados_activos, cantidad_empleados_area, promedio_de_edad
...
def EstadisticasEmpleados():
    ...
    print("="*43)
    activos, inactivos = cantidad_entidad(0, 5)
...
def EditarEmpleado():
    ...
    match campo:
        case 1:
            nuevo_valor = input("Ingrese el nuevo nombre y apellido: ").strip().title()
